    ...
    <main>
      ...
      <article className="privacy-tos">
        ...
        <p>
          ...
          you, whether personally or on behalf of an entity (“you”) and Laurens
          Spangenberg (“Company,” “we,” “us,” or “our”), concerning your access
          to and use of the https://example.com website as well as any other
        ...
        <h2 id="submissions">10. SUBMISSIONS</h2>
        <p>
        ...
        <p>
          ...
          hosted in the Netherlands. If you access the Site from any other
          ...
          in the Netherlands, then through your continued use of the Site, you
          are transferring your data to the Netherlands, and you agree to have
        ...
        <p>
          ...
          provisions of the law of your country of residence. Laurens
          Spangenberg and yourself both agree to submit to the non-exclusive
          jurisdiction of the courts of Amsterdam, which means that you may make
          a claim to defend your consumer protection rights in regards to these
          Conditions of Use in the Netherlands, or in the EU country in which
          you reside.
        </p>
        ...
        <p>Laurens Spangenberg laurens.am.spangenberg@gmail.com</p>
      </article>
      <Footer />
    </main>
  );
